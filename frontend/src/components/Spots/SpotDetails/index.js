            ...
            <img
              ...
              src={
                previewImage && previewImage.url
                  ? previewImage.url
                  : "https://a0.muscache.com/im/pictures/prohost-api/Hosting-549139249395273435/original/ed7f1dbc-e834-478e-974d-0bea94926f0b.jpeg"
              }
              alt={`${spot.name}`}
            />
          </div>
      ...
      <section className="reviews-section">
        ...
        {canPostReview && (
          <OpenModalButton
            ...
            modalComponent={
              <CreateReview spotId={spotId} createNewReview={createNewReview} />
            }
          />
        )}
