...
export default function EditSpot() {
  ...
  return (
    <div className="create-spot__container">
      ...
      <p>
        Guest's will only get your exact address once they booked a reservation
      </p>
      <form className="create-spot__form">
        <div className="section">
          <div className="create-spot__input">
            <label htmlFor="country">Country</label>
            {errors && <span className="error">{errors.country}</span>}
            <input
          ...
          <div className="create-spot__input">
            ...
            {errors && <span className="error">{errors.address}</span>}
            <input
              className="form-input"
              id="address"
              name="address"
          ...
          <div className="flex-columns">
            <div className="input-container__city">
              ...
              {errors && <span className="error">{errors.city}</span>}
              <input
                className="form-input"
                id="city"
                name="city"
            ...
            <div className="input-container__state">
              ...
              {errors && <span className="error">{errors.state}</span>}
              <input
                className="form-input"
                id="state"
                name="state"
        ...
        <div className="section">
          ...
          <p>
            Mention the best features of your place, special ammenities like
        ...
        <div className="section">
          ...
          />
          {errors && <span className="error">{errors.previewImage}</span>}
          <input
            className="form-input"
            id="image1"
            type="text"
          ...
          />
          {errors && <span className="error">{errors.image1}</span>}
          <input
            className="form-input"
            id="image2"
            type="text"
          ...
          />
          {errors && <span className="error">{errors.image2}</span>}
          <input
            className="form-input"
            id="image3"
            type="text"
          ...
          />
          {errors && <span className="error">{errors.image3}</span>}
          <input
            className="form-input"
            id="image4"
            type="text"
          ...
          />
          {errors && <span className="error">{errors.image4}</span>}
        </div>
        <button
          type="submit"
