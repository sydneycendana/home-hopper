  ...
  return (
    <div className="welcome-modal-container">
      <div className="welcome-modal-text-wrapper">
        <h1>Welcome to Home Hopper!</h1>
        <p>
          This is my first full stack project meant to mimick a partially
          functional clone of the popular Airbnb platform. Users can create an
          account, list a place to stay, and add reviews for other people's
          places.
        </p>
